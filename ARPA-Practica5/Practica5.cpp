...
constexpr int NUM_DATOS = 3;        // Número de datos a enviar (3 veces)
constexpr const char* NOMBRE_FICHERO = "a.dat";  // Nombre del fichero
...
int main(int argc, char* argv[]) {
    ...
    MPI_File fh;
    MPI_File_open(MPI_COMM_WORLD, const_cast<char*>(NOMBRE_FICHERO), MPI_MODE_CREATE | MPI_MODE_RDWR, MPI_INFO_NULL, &fh);
